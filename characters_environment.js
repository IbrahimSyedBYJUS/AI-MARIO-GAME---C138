...
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press Start Button and look directly into the webcam to begin the game!", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
  ...
  if(gameConfig.status==='gameover'){
    ...
    textSize(15);
    text("Press Play to restart!", gameConfig.screenX/2, gameConfig.screenY/2+135);
    textSize(40);
